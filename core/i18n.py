...
TRANSLATIONS = {
    "en": {
        ...
        "Avant de vous enrôler": "Before you enrol",
        "Comprendre le fonctionnement de l'épargne Blue Sky": "Understand how Blue Sky savings works",
        "Vous effectuez des dépôts selon votre capacité. Blue Sky conserve votre épargne avec un suivi rigoureux et vous permet de demander un retrait lorsque vous en avez besoin, conformément aux conditions du service.": "You make deposits according to your means. Blue Sky keeps your savings under careful monitoring and allows you to request a withdrawal when needed, subject to the service conditions.",
        "Des dépôts à votre rythme": "Deposits at your own pace",
        "Alimentez progressivement votre épargne avec les montants adaptés à votre situation.": "Build your savings gradually with amounts suited to your circumstances.",
        "Une conservation encadrée": "Carefully managed savings",
        "Vos opérations sont enregistrées et suivies avec sérieux par notre équipe.": "Your transactions are recorded and carefully monitored by our team.",
        "Un soutien pour vos projets": "Support for your projects",
        "Nous vous aidons à organiser votre effort d'épargne pour préparer des projets importants.": "We help you organise your savings to prepare for important projects.",
        "Une traçabilité fiable": "Reliable traceability",
        "Chaque dépôt et chaque retrait apparaissent dans votre historique pour un suivi clair.": "Every deposit and withdrawal appears in your history for clear tracking.",
        "Avant votre inscription, un conseiller vous présente les conditions, les modalités de dépôt et la procédure de retrait afin que vous puissiez vous engager en toute connaissance de cause.": "Before enrolment, an adviser explains the conditions, deposit arrangements and withdrawal process so you can make an informed decision.",
        ...
        "Nom de votre pays": "Name of your country",
        "Entrez le nom de votre pays": "Enter the name of your country",
        "Ex. Angola": "E.g. Angola",
    ...
    "sw": {
        ...
        "Avant de vous enrôler": "Kabla ya kujiandikisha",
        "Comprendre le fonctionnement de l'épargne Blue Sky": "Fahamu jinsi akiba ya Blue Sky inavyofanya kazi",
        "Vous effectuez des dépôts selon votre capacité. Blue Sky conserve votre épargne avec un suivi rigoureux et vous permet de demander un retrait lorsque vous en avez besoin, conformément aux conditions du service.": "Unaweka pesa kulingana na uwezo wako. Blue Sky huhifadhi akiba yako kwa ufuatiliaji makini na hukuruhusu kuomba kutoa pesa unapozihitaji, kwa mujibu wa masharti ya huduma.",
        "Des dépôts à votre rythme": "Weka pesa kwa mwendo wako",
        "Alimentez progressivement votre épargne avec les montants adaptés à votre situation.": "Ongeza akiba yako hatua kwa hatua kwa kiasi kinacholingana na hali yako.",
        "Une conservation encadrée": "Akiba inayosimamiwa kwa makini",
        "Vos opérations sont enregistrées et suivies avec sérieux par notre équipe.": "Miamala yako inarekodiwa na kufuatiliwa kwa umakini na timu yetu.",
        "Un soutien pour vos projets": "Msaada kwa miradi yako",
        "Nous vous aidons à organiser votre effort d'épargne pour préparer des projets importants.": "Tunakusaidia kupanga akiba yako ili kujiandaa kwa miradi muhimu.",
        "Une traçabilité fiable": "Ufuatiliaji wa kuaminika",
        "Chaque dépôt et chaque retrait apparaissent dans votre historique pour un suivi clair.": "Kila uwekaji na utoaji wa pesa unaonekana katika historia yako kwa ufuatiliaji ulio wazi.",
        "Avant votre inscription, un conseiller vous présente les conditions, les modalités de dépôt et la procédure de retrait afin que vous puissiez vous engager en toute connaissance de cause.": "Kabla ya kujiandikisha, mshauri anakueleza masharti, namna ya kuweka pesa na utaratibu wa kutoa pesa ili ufanye uamuzi ukiwa na taarifa kamili.",
        ...
        "Nom de votre pays": "Jina la nchi yako",
        "Entrez le nom de votre pays": "Weka jina la nchi yako",
        "Ex. Angola": "Mf. Angola",
